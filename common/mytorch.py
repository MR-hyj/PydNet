...
# File:     mytorch.py
# Product:  PyCharm
# Desc:     PyTorch related utility functions
...
class CheckPointManager(object):
    ...
    def _save_checkpoint(self, step, model, optimizer, score):
        ...
        if score > self._best_score:
            ...
            self._logger.info('Checkpoint is current best, score={:.8g}'.format(self._best_score))
...
class TorchDebugger(torch.autograd.detect_anomaly):
    ...
    def __exit__(self, dtype, value, trace):
        super().__exit__()
